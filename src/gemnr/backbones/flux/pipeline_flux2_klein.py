...
class Flux2KleinPipeline(DiffusionPipeline, Flux2LoraLoaderMixin):
    ...
    def prepare_latents(
        ...
        # print("latents shape pre prepare_latent_ids: ", latents.shape)
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if image_latents is not None:
                    # print("image latents concat place")
        ...
        self._current_timestep = None
        # print("latents shape pre _unpack_latents_with_ids: ", latents.shape)
        ...
        # print("latents shape pre _unpatchify_latents: ", latents.shape)
