...
class FluxKontextPipeline(
    ...
    def __call__(
        ...
        Returns:
            ...
            images.
        """
        print("Hello in local flux kontext pipeline!!!")
        ...
        self._current_timestep = None
        print("latents shape in end of pipeline: ", latents.shape)
        print("height in end of pipeline: ", height)
        print("width in end of pipeline: ", width)
        print("self.vae_scale_factor in end of pipeline: ", self.vae_scale_factor)
