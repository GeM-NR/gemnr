...
class CNNandDinov2(nn.Module):
    def __init__(self, cnn_kwargs = None, amp = False, use_vgg = False, dinov2_weights = None, amp_dtype = torch.float16):
        ...
        import sys
        from roma.models.transformer import vit_large
    ...
    def forward(self, x, upsample = False):
        ...
        print("Upsample in Encoder forward: ", upsample)
        if not upsample:
            # with torch.no_grad(): # TODO Temporarily turn of torch.no_grad
            print("Hello in Encoder no_grad section")
