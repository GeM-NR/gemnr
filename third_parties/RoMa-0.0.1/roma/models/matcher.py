...
from roma.utils.utils import cls_to_flow_refine, get_autocast_params
...
class RegressionMatcher(nn.Module):
    ...
    def match(
        ...
        # print("In match self.upsample_preds: ", self.upsample_preds)
        ...
        if self.upsample_preds:
            ...
            # torch.cuda.empty_cache() # TODO Maybe reactivate this
            # test_transform = get_tuple_transform_ops(
